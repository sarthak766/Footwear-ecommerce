...
const Card = ({ id,img, title, star, reviews, prevPrice, newPrice }) => {
  ...
  return (
    <div className="max-w-md bg-white shadow-lg rounded-lg overflow-hidden mx-2 my-4 md:w-[calc(100%/3)] w-[50%] hover:scale-[1.2] transition duration-300 ease-in-out">
