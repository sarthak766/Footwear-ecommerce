...
const Card = ({ id,img, title, star, reviews, prevPrice, newPrice }) => {
  ...
  return (
    <div className="max-w-md bg-white shadow-lg rounded-lg overflow-hidden mx-auto my-4 md:w-[30vw] md:h-[50vh] w-[80%] hover:scale-[1.2] transition duration-300 ease-in-out">
